...
#
# # Load the model
# model_path = "D://FCIH//GP//codes//_Detection//integrated//attack-agnostic-dataset-master//model3.pth"
...
#         'predicted_class': 'Real' if predicted_class.item() == 1 else 'Fake'
#     })
#
# if __name__ == '__main__':
#     app.run(debug=True, host='192.168.1.168')
...
# Load the model
model_path = "D://University//Kirollous Hany//4th-Year//GradProject//Det Model//rawnet81.pth"
loaded_object = torch.load(model_path)
loaded_object.eval()
