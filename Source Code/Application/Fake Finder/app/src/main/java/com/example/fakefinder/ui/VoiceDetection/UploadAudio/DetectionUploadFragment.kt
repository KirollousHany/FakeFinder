package com.example.fakefinder.ui.VoiceDetection.UploadAudio
...
import com.example.fakefinder.databinding.FragmentUploadDetectionBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class DetectionUploadFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_upload_detection, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        _binding = FragmentUploadDetectionBinding.bind(view)
    ...
    private fun onClicks() {
        ...
        binding.btnUpload.setOnClickListener {
            findNavController().navigate(
                DetectionUploadFragmentDirections.actionVoiceDetectionFragmentToWaitingDetectionFragment(
                    fileVoiceUser!!, fileName!!
                )
            )
        }
    }
