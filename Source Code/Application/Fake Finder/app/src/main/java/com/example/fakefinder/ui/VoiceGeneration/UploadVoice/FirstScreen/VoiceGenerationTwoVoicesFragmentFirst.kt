package com.example.fakefinder.ui.VoiceGeneration.UploadVoice.FirstScreen
...
import com.example.fakefinder.databinding.FragmentVoiceGenerationTwoVoicesFirstBinding

class VoiceGenerationTwoVoicesFragmentFirst : Fragment() {

    private var _binding: FragmentVoiceGenerationTwoVoicesFirstBinding? = null
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_voice_generation_two_voices_first,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentVoiceGenerationTwoVoicesFirstBinding.bind(view)
        onClicks()
        handleOnBackPressed()
    }
    ...
    private fun onClicks() {
        ...
        binding.btnNext.setOnClickListener {
            ...
            findNavController().navigate(
                VoiceGenerationTwoVoicesFragmentFirstDirections.actionVoiceGenerationTwoVoicesFragmentFirstToVoiceGenerationTwoVoicesFragmentSecond(
                    firstVoiceUser!!
                )
            )
        }
